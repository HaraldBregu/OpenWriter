...
import { Heading, Type, List, ListOrdered, Sparkles, Minus, ImagePlus, Loader2 } from 'lucide-react';
...
function getItemClass(tone: MenuItem['tone'], isSelected: boolean): string {
	if (tone === 'ai') {
		return isSelected
			...
			: 'bg-[hsl(var(--info)/0.1)] text-popover-foreground hover:bg-[hsl(var(--info)/0.16)] dark:bg-transparent dark:text-popover-foreground dark:hover:bg-[hsl(var(--info)/0.2)]';
	}
