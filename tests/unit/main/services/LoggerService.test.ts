...
describe('LoggerService', () => {
  ...
  describe('log cleanup', () => {
    it('should delete log files older than maxRetentionDays', () => {
      ...
      expect(mockUnlinkSync).toHaveBeenCalledWith(expect.stringContaining('2023-12-01.log'));
      expect(mockUnlinkSync).not.toHaveBeenCalledWith(expect.stringContaining('2024-01-01.log'));
    });
  ...
  describe('EventBus integration', () => {
    ...
    it('should log error:critical events at ERROR level', () => {
      ...
      eventBus.emit('error:critical', {
        error: new Error('Catastrophic failure'),
        context: 'Bootstrap',
      });
      service.flush();
