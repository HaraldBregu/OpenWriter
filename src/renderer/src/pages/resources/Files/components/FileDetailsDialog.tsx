...
export function FileDetailsDialog(): ReactElement | null {
	...
	return (
		<Dialog open={fileDetailsOpen} onOpenChange={handleFileDetailsOpenChange}>
			<DialogContent className="min-w-[calc(100vw-8rem)]">
						...
						<div className="p-6">
							<div className="[&_strong]:text-foreground space-y-4 [&_strong]:font-semibold">
								...
								<div className="space-y-1">
									...
									<p>
										&rdquo;Absolutely fantastic device! The performance is exceptional, and it
										handles all of my design software without any lag.&rdquo; - John D.
									</p>
									<p>
										&rdquo;Best purchase I&apos;ve made in years. The display quality is stunning,
										and the battery lasts all day.&rdquo; - Sarah L.
									</p>
									<p>
										&rdquo;The SuperTech 2000 is a game-changer in the tech industry. Worth every
										penny!&rdquo; - Emma W.
									</p>
								</div>
								<div className="space-y-1">
									...
									<p>
										If you&apos;re not satisfied with your purchase, we offer a 30-day return
										policy. Return the product within 30 days of purchase for a full refund.
									</p>
								</div>
								<div className="space-y-1">
									<p>
				...
				<DialogFooter >
					<DialogClose
						render={() => (
							<Button variant="outline" onClick={() => handleFileDetailsOpenChange(false)}>
								<ChevronLeftIcon />
								Back
							</Button>
						)}
