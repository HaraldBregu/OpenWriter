...
class MinimalAgent implements Agent {
	...
	async *run(input: AgentInput, runId: string, _signal: AbortSignal): AsyncGenerator<AgentEvent> {
...
class AllEventTypesAgent implements Agent {
	...
	async *run(_input: AgentInput, runId: string, _signal: AbortSignal): AsyncGenerator<AgentEvent> {
