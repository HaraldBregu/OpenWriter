...
import {
    ...
    setRedo,
    setUndo
} from "../webContentsHandler.js";
import { changeLanguageGlobal } from "../index.js";
...
export const BuildElectronMenu = (
    ...
    try {
        ...
        const recentDocumentsMenu = recentDocuments.length > 0
            ? recentDocuments.slice().reverse().map((doc: string) => ({
        ...
        const menuTemplate: MenuItemConstructorOptions[] = [
            ...
            },
            {
                ...
                submenu: [
                    {
                        label: translations("menu.format.font.label"), submenu: [
                            {
                            ...
                            { type: 'separator' },
                            {
                                ...
                                submenu: [
                                    { label: translations("menu.format.font.captalization.allCaps"), click: () => changeCapitalization(mainWindow, "allCaps") },
                                    { label: translations("menu.format.font.captalization.smallCaps"), click: () => changeCapitalization(mainWindow, "smallCaps") },
                                    { label: translations("menu.format.font.captalization.titleCase"), click: () => changeCapitalization(mainWindow, "titleCase") },
                                    { label: translations("menu.format.font.captalization.startCase"), click: () => changeCapitalization(mainWindow, "startCase") },
                                    { label: translations("menu.format.font.captalization.none"), click: () => changeCapitalization(mainWindow, "none") }
                                ]
                            },
                            {
                                label: translations("menu.format.font.ligature.label"),
                                submenu: [
                                    { label: translations("menu.format.font.ligature.default"), click: () => changeLigature(mainWindow, "standard") },
                                    { label: translations("menu.format.font.ligature.none"), click: () => changeLigature(mainWindow, "none") },
                                    { label: translations("menu.format.font.ligature.all"), click: () => changeLigature(mainWindow, "all") }
                                ]
                            },
                            {
                                label: translations("menu.format.font.characterSpacing.label"),
                                submenu: [
                                    { label: translations("menu.format.font.characterSpacing.normal"), click: () => changeCharacterSpacing(mainWindow, "normal") },
                                    { label: translations("menu.format.font.characterSpacing.tighten"), click: () => changeCharacterSpacing(mainWindow, "tighten") },
                                    { label: translations("menu.format.font.characterSpacing.loosen"), click: () => changeCharacterSpacing(mainWindow, "loosen") }
                                ]
                            },
                        ]
                    },
                    {
                        label: translations("menu.format.text.label"), submenu: [
                            {
