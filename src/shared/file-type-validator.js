...
export function validateTextFile(filePath) {
    ...
    if (IMAGE_FILE_EXTENSIONS.includes(lowerExt)) {
        return {
            isValid: false,
            fileType: 'image',
            extension: lowerExt,
    ...
    if (VIDEO_FILE_EXTENSIONS.includes(lowerExt)) {
        return {
            isValid: false,
            fileType: 'video',
            extension: lowerExt,
    ...
    // Check if it's audio
    if (AUDIO_FILE_EXTENSIONS.includes(lowerExt)) {
        return {
            isValid: false,
            fileType: 'audio',
            extension: lowerExt,
    ...
    if (BINARY_FILE_EXTENSIONS.includes(lowerExt)) {
        return {
            isValid: false,
            fileType: 'binary',
            extension: lowerExt,
 ...
 */
export function validateTextFiles(filePaths) {
    const validFiles = [];
    const invalidFiles = [];
 ...
 */
export function getRejectedFileTypesDescription() {
