...
import type { ChunkOptions } from '../ingestion/text-chunker';
import { chunkText } from '../ingestion/text-chunker';
import type { ExtractorRegistry } from '../ingestion/extractor-registry';
import { DocumentIndexStore } from '../store/document-index-store';
...
export interface VectorIndexingPipelineOptions {
