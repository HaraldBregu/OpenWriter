...
import type { ContentReviewerLlmCaller, ContentReviewerStreamParams } from './types';

export class OpenAIContentReviewerLlmCaller implements ContentReviewerLlmCaller {
	constructor(
		private readonly client: OpenAI,
		private readonly timeoutMs: number
	) {}

	async stream(params: ContentReviewerStreamParams, signal: AbortSignal): Promise<string> {
...
function buildParams(
	params: ContentReviewerStreamParams
