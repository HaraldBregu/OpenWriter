...
export type ModelType = 'text' | 'image' | 'video' | 'multimodal' | 'embedding' | 'audio' | 'code' | 'reasoning';
...
export declare const FILES_EXTENSIONS: readonly [".json", ".md", ".txt", ".pdf"];
export type FilesViewMode = 'list' | 'grid';
export type FileTypeFilter = 'all' | 'image' | 'video' | 'audio' | 'json' | 'markdown' | 'text' | 'pdf';
export type FilesSortKey = 'name' | 'createdAt' | 'mimeType' | 'size';
export type FilesSortDirection = 'none' | 'asc' | 'desc';
export declare const FILE_TYPE_FILTERS: {
...
export declare const IMAGES_EXTENSIONS: readonly [".jpg", ".jpeg", ".png", ".gif", ".webp", ".svg", ".avif", ".bmp"];
...
export type AgentPhase = 'queued' | 'thinking' | 'writing' | 'generating-image' | 'completed' | 'error' | 'cancelled';
...
export declare const TASK_STATUS_TEXT_KEY = "statusText";
export declare function getTaskStatusText(metadata?: Record<string, unknown>): string | undefined;
export declare function withTaskStatusText(metadata: Record<string, unknown> | undefined, statusText: string | undefined): Record<string, unknown> | undefined;
