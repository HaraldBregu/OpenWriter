...
// ---- Agent system ---------------------------------------------------------
// These types mirror AgentManagerTypes.ts and AgentDefinition.ts in the main
// process. They are re-declared here so that channels.ts (shared across all
// processes) can reference them without importing from src/main/.
