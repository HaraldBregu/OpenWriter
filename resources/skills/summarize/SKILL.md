---
name: summarize
description: Condense long content into a shorter summary at a target length (bullet list, TL;DR, abstract, executive summary). Use when the user asks for a recap, digest, or shorter version.
metadata:
  openwriter:
    scope: bundled
    emoji: "📝"
