...
const AppSidebarTrigger = React.memo(
	React.forwardRef<
		...
		React.ComponentPropsWithoutRef<typeof SidebarTrigger>
	>(({ className, ...props }, ref) => (
		<SidebarTrigger
			ref={ref}
			className={cn('text-sidebar-foreground hover:bg-sidebar-accent', className)}
			{...props}
		/>
	))
);
...
const AppSidebarRail = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarRail>,
		React.ComponentPropsWithoutRef<typeof SidebarRail>
	>(({ className, ...props }, ref) => (
...
const AppSidebarInset = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarInset>,
...
const AppSidebarInput = React.memo(
	React.forwardRef<
		...
		React.ComponentPropsWithoutRef<typeof SidebarInput>
	>(({ className, ...props }, ref) => (
...
const AppSidebarHeader = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarHeader>,
		React.ComponentPropsWithoutRef<typeof SidebarHeader>
	>(({ className, ...props }, ref) => (
...
const AppSidebarFooter = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarFooter>,
		React.ComponentPropsWithoutRef<typeof SidebarFooter>
	>(({ className, ...props }, ref) => (
...
const AppSidebarSeparator = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarSeparator>,
		React.ComponentPropsWithoutRef<typeof SidebarSeparator>
	>(({ className, ...props }, ref) => (
...
const AppSidebarGroupLabel = React.memo(
	...
	>(({ className, ...props }, ref) => (
		<SidebarGroupLabel
			ref={ref}
			className={cn('text-sidebar-foreground/70', className)}
			{...props}
		/>
	))
);
...
const AppSidebarGroupAction = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarGroupAction>,
		React.ComponentPropsWithoutRef<typeof SidebarGroupAction>
	>(({ className, ...props }, ref) => (
		<SidebarGroupAction
			ref={ref}
			className={cn('text-sidebar-foreground hover:bg-sidebar-accent', className)}
...
const AppSidebarGroupContent = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarGroupContent>,
...
const AppSidebarMenuAction = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarMenuAction>,
...
const AppSidebarMenuBadge = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarMenuBadge>,
		React.ComponentPropsWithoutRef<typeof SidebarMenuBadge>
	>(({ className, ...props }, ref) => (
...
const AppSidebarMenuSkeleton = React.memo(
	React.forwardRef<
		React.ElementRef<typeof SidebarMenuSkeleton>,
		React.ComponentPropsWithoutRef<typeof SidebarMenuSkeleton>
	>(({ className, ...props }, ref) => (
...
const AppSidebarMenuSub = React.memo(
	React.forwardRef<
		...
		React.ComponentPropsWithoutRef<typeof SidebarMenuSub>
	>(({ className, ...props }, ref) => (
