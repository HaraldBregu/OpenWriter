...
describe('StoreValidators', () => {
	...
	describe('validateApiToken', () => {
		...
		it('should reject tokens with dangerous characters', () => {
			expect(() => StoreValidators.validateApiToken('token<script>')).toThrow('invalid characters');
			expect(() => StoreValidators.validateApiToken("token'injection")).toThrow(
				'invalid characters'
			);
			expect(() => StoreValidators.validateApiToken('token"double')).toThrow('invalid characters');
