...
export const illustrateSkill: Skill = {
	name: 'illustrate',
	description:
		'Plan and request an illustration for a section of the document. Use when the user asks for imagery, diagrams, or a visual break between prose — the controller will dispatch the "image" action after this skill produces a prompt.',
	scope: 'bundled',
	metadata: { emoji: '🎨', tags: ['image', 'visual'] },
	tools: ['read'],
	instructions: [
		'## Illustrate Skill',
		'',
