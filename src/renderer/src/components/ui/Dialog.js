...
function DialogTitle({ className, ...props }) {
    return (_jsx(DialogPrimitive.Title, { "data-slot": "dialog-title", className: cn('cn-font-heading text-base leading-none font-medium', className), ...props }));
}
