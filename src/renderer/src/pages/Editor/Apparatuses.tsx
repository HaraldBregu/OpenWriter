...
import { addComment, editCommentContent, selectComment, selectCommentWithId, updateCommentList } from "./store/comment/comments.slice";
...
const Apparatuses = forwardRef(({
    ...
    useEffect(() => {
        if (visibleApparatuses.length === 1)
            setExpandedApparatuses([visibleApparatuses[0]])
    }, [visibleApparatuses])
                    ...
                    {visibleApparatuses.map((item, index) => (
                        <ReorderItem
                            ...
                            className={cn(
                                ...
                                !expandedApparatuses.includes(item) && item === visibleApparatuses[visibleApparatuses.length - 1] && expandedApparatuses.length === 0 &&
                            ...
                            <motion.div
                                ...
                                <motion.nav
                                    ...
                                    >
                                        <DragIndicator color="currentColor" intent='primary' variant='tonal' size='small' />
                                    </motion.div>
                                        ...
                                        <DropdownMenu onOpenChange={(_) => {
                                            ...
                                            <DropdownMenuTrigger asChild>
                                                <motion.button
                                                    ...
                                                    children={<More color="currentColor" intent='primary' variant='tonal' size='small' />}
                                                />
                                            </DropdownMenuTrigger>
                                            <DropdownMenuContent align="end">
                                                ...
                                                <DropdownMenuItem
                                                    disabled={apparatuses.length === 1 || (hasOneCriticalApparatus && item.type === 'CRITICAL')}
                                                    onClick={() => {
                                        ...
                                        <DropdownMenu onOpenChange={(_) => {
                                            ...
                                            <DropdownMenuTrigger asChild>
                                                <motion.button
                                                    ...
                                                    children={<PlusSimple color="currentColor" intent='primary' variant='tonal' size='small' />}
                                                />
                                            </DropdownMenuTrigger>
                                            <DropdownMenuContent align="end">
            ...
            <Dialog
                ...
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            {t('delete_apparatus_dialog.description')}
                        </DialogDescription>
                    </DialogHeader>
                    <DialogFooter>
                        <Button
                        ...
                        <Button
                            ...
                            onClick={() => {
                                ...
                                const newExpandedApparatuses = expandedApparatuses.filter(apparatus => apparatus.id !== apparatus.id);
                                setExpandedApparatuses(newExpandedApparatuses);
