...
Object.defineProperty(window, 'bluetooth', {
	value: {
		...
		getInfo: jest
			.fn()
			.mockResolvedValue({ platform: 'win32', supported: true, apiAvailable: true }),
	},
	writable: true,
	configurable: true,
});
...
Object.defineProperty(window, 'network', {
	value: {
		...
		getInfo: jest
			.fn()
			.mockResolvedValue({ platform: 'win32', supported: true, isOnline: true, interfaceCount: 0 }),
...
Object.defineProperty(window, 'workspace', {
	value: {
		...
		directories: {
			...
			add: jest
				.fn()
				.mockResolvedValue({ id: '1', path: '/test', addedAt: Date.now(), isIndexed: false }),
...
Object.defineProperty(window, 'agent', {
	value: {
		...
		getStatus: jest
			.fn()
			.mockResolvedValue({ totalSessions: 0, activeSessions: 0, totalMessages: 0 }),
