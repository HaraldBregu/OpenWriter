		...
		>
			<div style={transitionStyles} className="relative will-change-transform">
				<Card
					size="sm"
					className={cn(
						'flex flex-col gap-1! py-2! px-2.5! w-47',
						...
						<Tooltip>
							...
							<TooltipContent>
								<div className="flex flex-col items-start gap-0.5">
									<span>Bold</span>
									<span className="text-[10px] opacity-70">{`${modKey} B`}</span>
								</div>
							</TooltipContent>
						</Tooltip>
						<Tooltip>
						...
						<Tooltip>
							...
							<TooltipContent>
								<div className="flex flex-col items-start gap-0.5">
									...
									<span className="text-[10px] opacity-70">{`${modKey} ${shiftKey} 7`}</span>
								</div>
							</TooltipContent>
						</Tooltip>
						<Tooltip>
					...
					<div className="flex flex-row items-center gap-0.5">
						<Tooltip>
							...
							<TooltipContent>
								<div className="flex flex-col items-start gap-0.5">
									<span>Cut</span>
									<span className="text-[10px] opacity-70">{`${modKey} X`}</span>
								</div>
							</TooltipContent>
						</Tooltip>
						<Tooltip>
