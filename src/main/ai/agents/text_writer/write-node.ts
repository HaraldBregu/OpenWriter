 ...
 *
 * Streams newly generated text through the injected model based on the user's
 * prompt. The model is injected via closure from graph.ts — this node never
 * constructs or configures LLM instances directly.
 */
