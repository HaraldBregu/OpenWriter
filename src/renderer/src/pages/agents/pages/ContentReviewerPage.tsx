			...
			<Card>
				...
				<CardContent>
					<FieldGroup>
						...
						<Field>
							<FieldLabel htmlFor="agent-content-reviewer-provider">
							...
							<Select
								...
								disabled={isBusy}
							>
								<SelectTrigger id="agent-content-reviewer-provider">
									<SelectValue
						...
						{providerId && (
							<Field>
								<FieldLabel htmlFor="agent-content-reviewer-model">
								...
								>
									<SelectTrigger id="agent-content-reviewer-model">
										<SelectValue
											placeholder={
												isLoadingModels
