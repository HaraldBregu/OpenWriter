...
export const rewriteSkill: Skill = {
	name: 'rewrite',
	description:
		'Rewrite a passage in a requested tone, voice, or register (formal, casual, academic, marketing, plain-English, etc.) without changing the underlying meaning. Use when the user asks to "make this sound X" or "rephrase".',
	scope: 'bundled',
	metadata: { emoji: '✍️', tags: ['editing', 'style'] },
	tools: ['read', 'edit'],
	instructions: [
		'## Rewrite Skill',
		'',
