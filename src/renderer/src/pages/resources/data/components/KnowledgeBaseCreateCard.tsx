...
export function KnowledgeBaseCreateCard({
	...
	return (
		<Card className="group flex min-h-[220px] flex-col items-center justify-center border-dashed transition-colors hover:border-primary/50 hover:bg-accent/30">
			<CardContent className="flex flex-col items-center gap-4 p-6 text-center">
				...
				<div className="space-y-1">
					...
					<p className="text-xs text-muted-foreground">
						Embed and index your documents for AI retrieval
					</p>
				</div>
