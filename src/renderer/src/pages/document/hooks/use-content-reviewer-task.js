...
export function useContentReviewerTask(opts) {
    ...
    const submit = useCallback(async (payload) => {
        if (!documentId || isBusyRef.current)
            return;
