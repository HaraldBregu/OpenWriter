...
function ComboboxClear({ className, ...props }) {
    return (_jsx(ComboboxPrimitive.Clear, { "data-slot": "combobox-clear", className: cn(className), ...props, render: _jsx(InputGroupButton, { variant: "ghost", size: "icon-xs", children: _jsx(XIcon, { className: "pointer-events-none" }) }) }));
}
...
function ComboboxChip({ className, children, showRemove = true, ...props }) {
    return (_jsxs(ComboboxPrimitive.Chip, { "data-slot": "combobox-chip", className: cn('flex h-[calc(--spacing(5.25))] w-fit items-center justify-center gap-1 rounded-sm bg-muted px-1.5 text-xs font-medium whitespace-nowrap text-foreground has-disabled:pointer-events-none has-disabled:cursor-not-allowed has-disabled:opacity-50 has-data-[slot=combobox-chip-remove]:pr-0', className), ...props, children: [children, showRemove && (_jsx(ComboboxPrimitive.ChipRemove, { className: "-ml-1 opacity-50 hover:opacity-100", "data-slot": "combobox-chip-remove", render: _jsx(Button, { variant: "ghost", size: "icon-xs", children: _jsx(XIcon, { className: "pointer-events-none" }) }) }))] }));
}
