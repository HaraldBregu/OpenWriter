...
export const AI_MODELS: readonly ModelInfo[] = [
	// ========================== OpenAI ========================================
	{
		...
		toolsSupported: ['function_calling', 'web_search', 'file_search', 'code_interpreter'],
		endpoints: ['responses', 'chat.completions'],
		snapshots: ['gpt-5.4', 'gpt-5.4-latest'],
		rateLimits: 'tier_based_dynamic',
	...
	// ========================== DeepSeek ======================================
	{
		...
		features: ['streaming', 'tool_calling', 'json_mode', 'prompt_caching'],
		notes: '671B MoE (37B active), OpenAI-compatible API',
	},
	{
		provider: 'DeepSeek',
		...
		cachedInputPricePerMillionTokens: 0.028,
		outputPricePerMillionTokens: 0.42,
		features: ['streaming', 'tool_calling', 'chain_of_thought'],
		notes: '671B MoE (37B active), chain-of-thought reasoning model',
	},
	...
	// ========================== Qwen (Alibaba) ================================
	{
		...
		maxOutputTokens: 65536,
		inputPricePerMillionTokens: 0.26,
		outputPricePerMillionTokens: 1.56,
		notes: 'Latest flagship with 1M context',
	},
	{
		provider: 'Qwen',
		...
		notes: 'Ultra-fast with 1M context',
	},
	{
		provider: 'Qwen',
		modelId: 'qwen3-max',
		...
		contextWindow: 262144,
		maxOutputTokens: 32768,
		inputPricePerMillionTokens: 0.78,
		outputPricePerMillionTokens: 3.9,
		notes: 'Top-tier reasoning with native search agents',
	},
	{
		provider: 'Qwen',
		modelId: 'qwen3-plus',
		...
		outputPricePerMillionTokens: 0.45,
	...
	},
	{
		...
		contextWindow: 262144,
		maxOutputTokens: 32768,
		inputPricePerMillionTokens: 0.22,
		outputPricePerMillionTokens: 0.9,
		notes: '480B MoE model (35B active), agentic coding',
	},
	{
		provider: 'Qwen',
		...
		notes: '235B MoE vision-language model, supports video input',
	},
	{
		provider: 'Qwen',
		modelId: 'qvq-max',
	...
	},
	{
		...
		contextWindow: 8192,
		maxOutputTokens: null,
		inputPricePerMillionTokens: 0.02,
		notes: '#1 on MTEB multilingual leaderboard',
	},
	{
		provider: 'Qwen',
		modelId: 'qwen-long',
		...
		contextWindow: 10000000,
		maxOutputTokens: 8192,
		notes: 'Ultra-long context for document analysis',
	},
