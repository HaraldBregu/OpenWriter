...
import { loadCurrentWorkspace, listWorkspaces, selectWorkspace, createWorkspace, clearWorkspace, loadResources, removeResources, loadIndexingInfo, loadProjectName, } from './actions';
// ---------------------------------------------------------------------------
// Slice
// ---------------------------------------------------------------------------
export const workspaceSlice = createSlice({
    ...
    reducers: {
         ...
         */
        handleWorkspaceChanged: (state, action) => {
         ...
         */
        handleWorkspaceDeleted: (state, action) => {
         ...
         */
        importResourcesRequested: (state, _action) => {
        ...
        documentMetadataPatched(state, action) {
        ...
        documentsLoadingFailed(state, action) {
...
export const { handleWorkspaceChanged, handleWorkspaceDeleted, clearDeletionReason, resourceRemoved, importResourcesRequested, importResourcesCompleted, documentsLoaded, documentAdded, documentUpdated, documentMetadataPatched, documentRemoved, documentSelected, documentsLoadingStarted, documentsLoadingFailed, } = workspaceSlice.actions;
