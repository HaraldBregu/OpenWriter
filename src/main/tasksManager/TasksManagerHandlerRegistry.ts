import type { TasksManagerHandler } from './TasksManagerHandler'
 ...
 */
export class TasksManagerHandlerRegistry {
  private handlers = new Map<string, TasksManagerHandler>()
   ...
   */
  register(handler: TasksManagerHandler): void {
   ...
   */
  get(type: string): TasksManagerHandler {
